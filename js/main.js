...
(function ($) {
  ...
  try {
    ...
    var ctx = document.getElementById("percent-chart2");
      ...
      var x = parseInt(document.getElementById("pending_tasks").value)
      var y = parseInt(document.getElementById("completed_tasks").value)
      var z = parseInt(document.getElementById("overdue_tasks").value);
    if (ctx) {
      ctx.height = 209;
      var myChart = new Chart(ctx, {
        type: 'doughnut',
